...
/***/ "./source/js/modules/countdown.js":
/*!****************************************!*\
  !*** ./source/js/modules/countdown.js ***!
  \****************************************/
/*! exports provided: default */
...
/* harmony import */ var _countdown__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./countdown */ "./source/js/modules/countdown.js");
...
class FullPageScroll {
  constructor() {
    ...
    this.timer = new _timer__WEBPACK_IMPORTED_MODULE_2__["default"]({container: document.querySelector(`.game__counter`)});
  }
    ...
    document.querySelectorAll(`[data-prize]`).forEach((element) => {
      ...
      if (!this.Prizes[element.dataset.prize].element.classList.contains(`active`)) {
        setTimeout(() => {
          ...
          const countdown = new _countdown__WEBPACK_IMPORTED_MODULE_1__["default"]({
...
/* harmony import */ var _theme__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./theme */ "./source/js/modules/theme.js");
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  const theme = new _theme__WEBPACK_IMPORTED_MODULE_1__["Theme"]();
        ...
        on: {
          slideChange: () => {
            if (storySlider.activeIndex === 0 || storySlider.activeIndex === 1) {
              theme.setTheme(_theme__WEBPACK_IMPORTED_MODULE_1__["themeClass"].violet);
              sliderContainer.style.backgroundImage = `url("img/slide1.jpg"), linear-gradient(180deg, rgba(83, 65, 118, 0) 0%, #523E75 16.85%)`;
            } else if (storySlider.activeIndex === 2 || storySlider.activeIndex === 3) {
              theme.setTheme(_theme__WEBPACK_IMPORTED_MODULE_1__["themeClass"].blue);
              ...
              theme.setTheme(_theme__WEBPACK_IMPORTED_MODULE_1__["themeClass"].lightblue);
              ...
              theme.setTheme(_theme__WEBPACK_IMPORTED_MODULE_1__["themeClass"].darkviolet);
...
/*!************************************!*\
  !*** ./source/js/modules/theme.js ***!
  \************************************/
/*! exports provided: themeClass, Theme */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./source/js/modules/typography.js":
/*!*****************************************!*\
  !*** ./source/js/modules/typography.js ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Typography; });
...
/* harmony import */ var _modules_typography__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/typography */ "./source/js/modules/typography.js");
const DELAY = 600;
  ...
  if (document.querySelector(`[data-typography]`)) {
    document.querySelectorAll(`[data-typography]`).forEach((element) => {
      if (element.classList.contains(`intro__date`)) {
        const typographyElement = new _modules_typography__WEBPACK_IMPORTED_MODULE_9__["default"](element, DELAY);
        typographyElement.init();
      } else {
        const typographyElement = new _modules_typography__WEBPACK_IMPORTED_MODULE_9__["default"](element);
        typographyElement.init();
      }
    });
  }
